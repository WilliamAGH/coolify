...
{
    private const FILENAME_PATTERN = '/\A2026_07_12_[0-9]{6}_[a-z0-9_]+\.php\z/';

    private const GLOB = '2026_07_12_*.php';
    ...
    public static function names(
        ...
        $migrationPaths = glob($migrationDirectory.DIRECTORY_SEPARATOR.self::GLOB, GLOB_NOSORT);
