...
final readonly class BlueGreenFinalizedRecoveryPlan
{
    ...
    public function __construct(
        ...
        if ($this->publicRoutes === [] || $this->publicAcknowledgement === '') {
            throw new \InvalidArgumentException('A finalized recovery plan requires public routes and an opaque acknowledgement.');
        }
    }
}
