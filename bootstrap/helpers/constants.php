...
const DEFAULT_BLUE_GREEN_INACTIVE_RETENTION_SECONDS = 0;
const MIN_BLUE_GREEN_INACTIVE_RETENTION_SECONDS = 0;
const MAX_BLUE_GREEN_INACTIVE_RETENTION_SECONDS = 3600;
const DEFAULT_BLUE_GREEN_REPLICA_COUNT = 1;
const MIN_BLUE_GREEN_REPLICA_COUNT = 1;
const MAX_BLUE_GREEN_REPLICA_COUNT = 32;
