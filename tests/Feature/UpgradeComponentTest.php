...
function createUpgradeComponentInstanceSettings(bool $newVersionAvailable): InstanceSettings
{
...
it('initializes latest version during mount from cached versions data', function () {
    ...
    createUpgradeComponentInstanceSettings(true);
...
it('falls back to 0.0.0 during mount when cached versions data is unavailable', function () {
    createUpgradeComponentInstanceSettings(false);
