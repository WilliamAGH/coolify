...
function blueGreenComposeClaim(Application $application, StandaloneDocker $destination, ?BlueGreenDeploymentColor $previousActiveColor): BlueGreenDeploymentClaim
{
