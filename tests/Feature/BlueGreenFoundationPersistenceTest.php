...
it('keeps blue-green member discovery labels free of persistent Traefik health checks', function (BlueGreenDeploymentColor $color): void {
    ...
    expect($labels)
        ...
        ->toContain("traefik.http.routers.{$webDiscoveryRouter}.service=noop@internal")
        ->toContain("traefik.http.routers.{$metricsDiscoveryRouter}.service=noop@internal")
...
it('rejects invalid blue-green deployment claims before remote work starts', function () {
    expect(fn () => new BlueGreenDeploymentClaim(
        ...
        operationTopologyDigest: str_repeat('a', 64),
        routingTopologyDigest: str_repeat('c', 64),
    ...
    expect(fn () => new BlueGreenDeploymentClaim(
        ...
        destinationFenceEpoch: 1,
        serverBootId: '11111111-2222-3333-4444-555555555555',
        operationTopologyDigest: 'not-a-digest',
        routingTopologyDigest: str_repeat('c', 64),
        routingConfigDigest: str_repeat('b', 64),
        backendPortInventory: BlueGreenBackendPortInventory::fromPorts([3000]),
        drainBackendPortInventory: BlueGreenBackendPortInventory::fromPorts([3000]),
