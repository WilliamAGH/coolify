...
it('excludes the current helper image from any registry', function () {
...
it('protects the current helper image from any registry even when no applications exist', function () {
